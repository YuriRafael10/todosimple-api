...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    public ResponseEntity<Object> handleObjectNotFoundException(
            ObjectNotFoundExcpetion objectNotFoundException,
            WebRequest request) {
    ...
    @ExceptionHandler(DataBindingViolationExcpetion.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    public ResponseEntity<Object> handleDataBindingViolationException(
            DataBindingViolationExcpetion dataBindingViolationException,
            WebRequest request) {
    ...
    public ResponseEntity<Object> handleAuthenticationException(
            AuthenticationException authenticationException, WebRequest request) {
    ...
    public ResponseEntity<Object> handleAuthorizationException(
            AuthorizationException authorizationException, WebRequest request) {
    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
        ...
        ErrorResponse errorResponse = new ErrorResponse(status, "Username ou senha inválida.");
